...
namespace BlankProcess
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        ...
        {
            _ = new System.Type[]{typeof(UiPath.Core.Activities.API.ISystemService), typeof(UiPath.Mail.Activities.Api.IMailService), typeof(UiPath.Testing.API.ITestingService), typeof(UiPath.UIAutomationNext.API.Contracts.IUiAutomationAppService), typeof(UiPath.Excel.Activities.API.IExcelService)};
        }
...
namespace BlankProcess.ObjectRepository
{
...
namespace BlankProcess._Implementation
{
